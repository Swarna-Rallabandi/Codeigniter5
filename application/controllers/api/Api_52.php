...
//method for GET shed_52 antenna report based on date selection
//url for antenna_report_get method for json result   
    //http://turing.une.edu.au/~srallaba/CodeIgniter5/index.php/api/Api_52/antenna_report?date=2017/03/05
    
//Get: method     
 public function antenna_report_get(){
//date picking format 2017/03/05 or yyyy/mm/dd
$date = $this->input->get('date');
//if the date is not null call the show_antenna_data_by_date_52 method from model to select the date
if ($date != "") {
...
//url for reader_report_get method for json result   
    //http://turing.une.edu.au/~srallaba/CodeIgniter5/index.php/api/Api_52/reader_report?date=2017/03/05
...
//if the date is not null call the show_reader_data_by_date_52 method from chook_model to select the date
if ($date != "") {
//save the json format result in variable on particular date
...
//url for epc_report_get method for json result       //http://turing.une.edu.au/~srallaba/CodeIgniter5/index.php/api/Api_52/epc_report
//Get: method    
 public function epc_report_get() {
//it calls the show_epc_data_52 method from chook_model and stores the data in result variable      
...
//finally it gives json response     
        $this->response($data); 
}
